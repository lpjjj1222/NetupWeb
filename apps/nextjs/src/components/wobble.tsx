    ...
    <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-4 lg:grid-cols-3">
      ...
      >
        <div style={{minHeight:'80%', minWidth:'50%'}} >
          ...
          <p className="mt-4 mr-1 text-left  text-base/6 text-gray-900">Say goodbye to nonresponse emails, matching long-lasting connections and personal growth for all parties involved. </p>
        </div>
        <img
