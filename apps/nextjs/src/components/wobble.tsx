    ...
    <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-4 lg:grid-cols-3">
      ...
      >
        <div style={{minHeight:'80%', minWidth:'50%'}} >
          ...
          <p className="mt-4 mr-1 text-left  text-base/6 text-gray-900">Utilize the easy event scheduler to plan one-on-one or group coffee chats and meals, and kickstart networking interactions during others&apos; events, meals, or coffee chats. </p>
        </div>
        <img
      ...
      <WobbleCard 
      bgColor="#F8CD80"
      containerClassName="col-span-1 min-h-[300px] py-0 px-0" >
        ...
        Say goodbye to nonresponse emails, matching long-lasting connections and personal growth for all parties involved.
        </p>
      </WobbleCard>
      <WobbleCard 
      bgColor="#FFC3D8"
